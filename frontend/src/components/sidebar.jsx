...
const Sidebar = () => {
    return (
        <div className="absolute left-2 lg:w-[23%] 2xl:w-[17%] md:w-[23%] sm:w-[23%] bg-white/5 rounded-lg h-[calc(100%-144px)]">
            <div className="flex text-white/35 w-full hover:text-white shadow-2xl shadow-black-40 rounded-t-lg transition font-semibold items-center text-xl justify-between py-4 px-4 ">
